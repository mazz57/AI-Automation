    ...
    <section className="relative py-20 sm:py-24 lg:py-32 border-y border-white/[0.05]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={viewport}
          className="bg-surface-1 rounded-2xl border border-white/[0.08] overflow-hidden shadow-[0_24px_64px_rgba(0,0,0,0.4),inset_0_1px_0_0_rgba(255,255,255,0.04)]"
        >
          {/* Titlebar */}
          <div className="border-b border-white/[0.06] px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-4 bg-white/[0.01]">
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            >
              {stats.map((stat) => (
                <motion.div
                  ...
                  className="bg-surface-2/60 rounded-xl border border-white/[0.06] p-3 sm:p-4 cursor-default shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03)]"
                >
            ...
            {/* Leads table — staggered rows */}
            <div className="bg-surface-2/40 rounded-xl border border-white/[0.06] overflow-hidden shadow-[inset_0_1px_0_0_rgba(255,255,255,0.02)]">
              <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-white/[0.06] flex items-center justify-between bg-white/[0.01]">
                  ...
                  >
                    <div className="flex items-center gap-3 sm:gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground truncate hidden sm:block">{lead.email}</div>
                      </div>
                    </div>
                      ...
                      <span
                        className={`text-xs px-2 py-1 rounded-full whitespace-nowrap ${
                          lead.status === "Qualified"
                            ...
                            : "bg-surface-3 text-muted-foreground border border-white/[0.06]"
                        }`}
                      >
                        {lead.status}
                      </span>
                      <div className="text-sm font-medium hidden sm:block text-foreground/70">{lead.score}</div>
                    </div>
                  </motion.div>
                ))}
              </motion.div>
