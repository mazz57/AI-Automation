...
export function Projects() {
  return (
    <section id="work" className="relative py-20 sm:py-24 lg:py-32 border-t border-white/5">
          ...
          {projects.map((project, projectIndex) => (
            ...
            >
              ...
              <motion.div
                ...
                className="relative aspect-16/10 bg-surface-1/95 rounded-2xl border border-white/10 overflow-hidden mb-5 sm:mb-6 shadow-[0_14px_48px_rgba(0,0,0,0.38),inset_0_1px_0_0_rgba(255,255,255,0.05)]"
              >
                <div className="absolute inset-0 p-3 sm:p-4">
                  ...
                  <div className="flex gap-2 mb-3">
                    {project.metrics.map((metric) => (
                      <div 
                        key={metric.label} 
                        className="flex-1 bg-surface-2/80 rounded-lg border border-white/8 p-2 sm:p-2.5 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03)]"
                      >
                  ...
                  <div className="bg-surface-2/60 rounded-lg border border-white/8 p-2 sm:p-3 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.03)]">
                  ...
                  <div className="mt-2 sm:mt-3 space-y-1.5">
                    {[0.7, 0.5, 0.35].map((w, i) => (
                      <div key={i} className="flex items-center gap-2">
                        <div className="w-5 h-5 sm:w-6 sm:h-6 bg-surface-3/70 rounded-full border border-white/6" />
